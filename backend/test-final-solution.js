...
console.log('🚀 Solución definitiva: Una empresa = Un registro...\n');
...
async function testFinalSolution() {
  try {
    ...
    // Solución definitiva: Una empresa = Un registro
    const empresasQuery = `
SELECT TOP 20
  e.IdEmpresa,
  e.Nombre AS empresa,
...
`;
    ...
    console.log(`   ✅ Solución definitiva: ${endTime1 - startTime1}ms (${result1.recordset.length} registros)`);
...
`;
    ...
    console.log('\n📈 Resumen final:');
    console.log(`   • Solución definitiva: ${endTime1 - startTime1}ms`);
    console.log(`   • Conteo total: ${endTime2 - startTime2}ms`);
