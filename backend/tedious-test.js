/**
 * Test with tedious driver and Windows Authentication
 */

const sql = require('mssql');
require('dotenv').config();

console.log('🔍 Testing with tedious driver...');
...
const config = {
  ...
  authentication: {
    type: 'ntlm',
    options: {
      domain: process.env.DB_DOMAIN || 'WORKGROUP',
      userName: process.env.DB_USER || 'fruge',
...
console.log(`  Auth: NTLM Windows Authentication`);
